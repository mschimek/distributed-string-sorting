...
sbatch --partition singlenode  --ntasks=20   --time=04:35:00 $1  >> jobIdsMultinodeFull.txt
sbatch --partition multinode   --ntasks=40   --time=04:15:00 $1  >> jobIdsMultinodeFull.txt
sbatch --partition multinode   --ntasks=80   --time=04:15:00 $1  >> jobIdsMultinodeFull.txt
