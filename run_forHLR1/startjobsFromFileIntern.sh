...
do
	...
	sbatch --partition multinode   --ntasks=160  --time=02:15:00 $outputFile >> $jobIds
	sbatch --partition multinode   --ntasks=320  --time=02:15:00 $outputFile >> $jobIds
	sbatch --partition multinode   --ntasks=480  --time=02:15:00 $outputFile >> $jobIds
	sbatch --partition multinode   --ntasks=640  --time=02:15:00 $outputFile >> $jobIds
	sbatch --partition multinode   --ntasks=960  --time=02:15:00 $outputFile >> $jobIds
	sbatch --partition multinode   --ntasks=1280  --time=02:15:00 $outputFile >> $jobIds
