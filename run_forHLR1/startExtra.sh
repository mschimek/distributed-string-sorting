...
#sbatch --partition singlenode  --ntasks=1    --time=00:05:00 $1  >> jobIdsMultinodeFull.txt
...
#sbatch --partition multinode   --ntasks=320  --time=06:15:00 $1  >> jobIdsMultinodeFull.txt
#sbatch --partition multinode   --ntasks=640  --time=04:15:00 $1  >> jobIdsMultinodeFull.txt
#jsbatch --partition multinode   --ntasks=960  --time=04:15:00 $1  >> jobIdsMultinodeFull.txt
sbatch --partition multinode   --ntasks=1280  --time=04:55:00 $1  >> jobIdsMultinodeFull.txt
