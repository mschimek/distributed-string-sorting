...
sbatch --partition singlenode  --ntasks=20   --time=01:35:00 $1  >> jobIdsMultinodeFull.txt
sbatch --partition multinode   --ntasks=40   --time=01:35:00 $1  >> jobIdsMultinodeFull.txt
sbatch --partition multinode   --ntasks=80   --time=02:15:00 $1  >> jobIdsMultinodeFull.txt
sbatch --partition multinode   --ntasks=160  --time=02:25:00 $1  >> jobIdsMultinodeFull.txt
