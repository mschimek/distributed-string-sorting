...
#ifndef TLX_SORT_STRINGS_MULTIKEY_QUICKSORT_UNIFIED_LCP_HEADER
#define TLX_SORT_STRINGS_MULTIKEY_QUICKSORT_UNIFIED_LCP_HEADER
...
static inline void multikey_quicksort(
    ...
    if (ss.get_char(*(a + r), depth) != 0)
        dss_schimek::multikey_quicksort(strptr.sub(a - ss.begin() + r,  (pa - a) + (pn - pd - 1)),
